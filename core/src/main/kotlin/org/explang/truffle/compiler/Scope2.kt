 ...
 */
class RootScope(override val tree: ExTree) : Scope2() {
  override fun resolve(symbol: ExSymbol): Resolution = Resolution.Unresolved(symbol, this)

  override val parent: Scope2 get() = this
 ...
 */
class FunctionScope(override val tree: ExLambda, override val parent: Scope2) : Scope2() {
 ...
 */
class BindingScope(override val tree: ExLet, override val parent: Scope2) : Scope2() {
